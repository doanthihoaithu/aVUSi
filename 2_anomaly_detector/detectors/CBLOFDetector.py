...
from detectors.cblof.model import CBLOF
from utils import transform_to_dimension_contribution


class CBLOFDetector(Detector):
    ...
    def train(self, data, labels=None):
        print("CBLOF does not require training, skipping...")
        return 0.0
    ...
    def predict(self, test_dict):
        ...
        for test_filename, data, labels, multivariate_labels, contamination in tqdm(zip(test_filenames,
            ...
            clf = CBLOF(
                ...
                n_clusters=self.customParameters.n_clusters,
                alpha=self.customParameters.alpha,
                beta=self.customParameters.beta,
                use_weights=self.customParameters.use_weights,
                random_state=self.customParameters.random_state,
                n_jobs=self.customParameters.n_jobs,
