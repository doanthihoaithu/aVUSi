...
class AutoEn():
    ...
    def __init__(self, latent_size = 32, epochs = 10, learning_rate = 0.005, noise_ratio = 0.1, early_stopping_patience: int = 10, early_stopping_delta: float = 1e-2,
                 split: float = 0.8, retrain: bool = False):
