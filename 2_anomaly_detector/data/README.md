...
|---|---|---|
| Synthetic (settings_six) | `settings_six` | Synthetic MTS generated by Module 1 with [`settings_six.yaml`](https://github.com/doanthihoaithu/synthsensor/blob/master/Python/generation/config/settings_six.yaml) (10 sensors, 974 batches) |
